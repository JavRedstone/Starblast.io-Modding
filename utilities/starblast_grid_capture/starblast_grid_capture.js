// Starblast Grid Capture

/*
  A mod that is game changing -- a manipulation of objects and ui components that form a game within a game.
  
  (P.S.: I'm not giving spoilers!)
  Enjoy!
*/
...
function generate_message (message, ship, color = "#cde", pos = [0, 10, 100, 5]) {
  ship.setUIComponent ({
